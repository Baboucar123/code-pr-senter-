...
int main() {
    ...
    Client client1("CIN12345", "Jean", "Dupont","07498589", 1234);
    Compte compte1(1001, 5000.0, client1);

    Client client2("CIN67890", "Marie", "Durand","01457896", 5678);
    Compte compte2(1002, 3000.0, client2);

    Client client3("CIN98765", "Paul", "Martin","04568789", 4321);
    Compte compte3(1003, 4000.0, client3);

    Client client4("CIN54321", "Alice", "Bernard","06489716", 8765);
